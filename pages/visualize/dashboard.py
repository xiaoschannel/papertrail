...
from analytics import monthly_spend, monthly_volume, top_merchants
...
dated_receipts = receipts[receipts["parsed_date"].notna()]

col1, col2 = st.columns(2)
with col1:
    if not dated_receipts.empty:
        st.subheader("Monthly Spending")
        monthly = monthly_spend(dated_receipts)
...
if not receipts.empty:
    ...
    leaderboard = top_merchants(receipts, key_col, value_col).rename(columns={key_col: label_col})
