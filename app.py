...
pg = st.navigation({
    ...
    "Dev": [
        ...
        st.Page("pages/dev/fix_leftover_extractions.py", title="Fix Leftover Extractions", icon=":material/cleaning_services:"),
        st.Page("pages/dev/fix_invalid_dates.py", title="Fix Invalid Dates", icon=":material/calendar_today:"),
    ],
    "": [
