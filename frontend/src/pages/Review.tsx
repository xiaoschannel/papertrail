                  ...
                  : (
                    <div className="review-layout">
                      <Card title="OCR text" className="review-col">
                        <pre className="textdump review-ocr">{currentDoc.ocr_text || 'No OCR text.'}</pre>
                      </Card>
                      ...
                      <Card title="Decision" className="review-col">
                        <ReviewForm doc={currentDoc} form={form} onChange={patchForm}
