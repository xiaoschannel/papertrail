...
import StraightenArchive from './pages/StraightenArchive.tsx'
...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/straighten-archive', label: 'Straighten Archive' },
    ],
  },
]
    ...
    <div className="app">
      ...
      <main className="main">
        <Routes>
          ...
          <Route path="/straighten-archive" element={<StraightenArchive />} />
